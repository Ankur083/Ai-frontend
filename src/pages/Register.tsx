    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button 
            type="submit"
            className="w-full bg-indigo-600 text-white py-4 rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200 mt-2"
          >
            Create Account
            <ArrowRight size={20} />
          </button>
