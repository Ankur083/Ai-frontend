        ...
        <AnimatePresence mode="wait">
          {!isFinished ? (
            <motion.div 
              ...
              exit={{ opacity: 0, y: -20 }}
              className="bg-white rounded-[40px] shadow-xl shadow-slate-200/50 p-10 sm:p-16 border border-slate-100"
            >
            ...
            <motion.div 
              ...
              className="bg-white rounded-[40px] shadow-xl shadow-slate-200/50 p-16 border border-slate-100 text-center"
            >
